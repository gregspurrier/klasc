...
describe 'Atoms:' do
  ...
  describe 'a symbol literal' do
    ...
    it 'may include any of the legal characters for symbol other than ; : { }' do
    ...
    it 'may begin with any legal character other than a digit or ; : { }' do
    ...
    %w(; : { }).each do |char|
      it "may be #{char} as a single character" do
        kl_eval(char).should == char.to_sym
      end
    end
