...
describe 'Primitives for Arithmetic' do
  describe '+' do
    ...
    it ('returns a real when either argument is a real') do
      kl_eval('(+ 1.1 2)').should be_kind_of Float
      kl_eval('(+ 1 2.1)').should be_kind_of Float
    end
  ...
  describe '-' do
    ...
    it ('returns a real when either argument is a real') do
      kl_eval('(- 3.1 2)').should be_kind_of Float
      kl_eval('(- 3 2.1)').should be_kind_of Float
    end
  ...
  describe '*' do
    ...
    it ('returns a real when either argument is a real') do
      kl_eval('(* 2.1 3)').should be_kind_of Float
      kl_eval('(* 2 3.1)').should be_kind_of Float
    end
  ...
  describe '/' do
    ...
    it ('returns a real when either argument is a real') do
      kl_eval('(/ 6.1 3)').should be_kind_of Float
      kl_eval('(/ 6 3.1)').should be_kind_of Float
    end
